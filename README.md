...
ドローンエンジニアとして業務に従事しています。<br>
プログラミングスクールにてWebアプリ開発を学び、卒業制作として「ココじゃ」を開発しました。
...
- **UI/UXの設計:** SNS特有の「返信疲れ」をなくすため、あえていいね・コメント機能を廃止。投稿＝投票というシンプルな体験に特化させました。
- **レスポンシブ対応:** 外出先（旅先）でも投稿しやすいよう、スマートフォンでの操作性を重視しました。
